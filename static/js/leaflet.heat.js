...
(function (factory, window) {
    ...
    L.HeatLayer = (L.Layer ? L.Layer : L.Class).extend({
        ...
        _initCanvas: function () {
            var canvas = this._canvas = L.DomUtil.create('canvas', 'leaflet-heatmap-layer leaflet-layer'),
                originProp = L.DomUtil.testProp(['transformOrigin', 'WebkitTransformOrigin', 'msTransformOrigin']);
        ...
        _updateOptions: function () {
            this._heat.radius(this.options.radius || this._heat._defaultRadius, this.options.blur);
    ...
    /*
     * A simple heatmap implementation based on simpleheat by Vladimir Agafonkin
    ...
    simpleheat.prototype = {
        ...
        _colorize: function (pixels, grad) {
